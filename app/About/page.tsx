...
const About = () => (
  <div className="header flex flex-col gap-[1.2rem] m-auto h-full">
    ...
    <p className='lg:text-2xl text-xl text-gray-400'>Mumbai, Maharashtra - hementchaubey@gmail.com</p>
    ...
    <div className="social-links flex flex-col gap-2">
      ...
      <a href="https://www.linkedin.com/in/hemant-chaubey-9400a1267/" target="_blank" rel="noopener noreferrer"><FaLinkedin size={35} color='darkblue' />
      </a>
      <a href="https://github.com/Hemantchuabey" target="_blank" rel="noopener noreferrer"><FaGithubSquare size={35} color=''/></a>
      <a href="https://leetcode.com/u/hemant_chaubey/" target="_blank" rel="noopener noreferrer"><SiLeetcode size={35} color='orange' />
      </a>
      <a href="https://x.com/Hemant1905" target="_blank" rel="noopener noreferrer"><FaSquareXTwitter size={35} color=''/>
      </a>
      </div>
    </div>
  </div>
